...
<body>
   <div>
         ...
         <div class="container">
            <div class="row">
               <div class="title-content  fadeIn" data--delay="0.3s">
                  <div class="col-lg-12">
                     <div class="tagline" data--delay="0.4s">About Us</div>
      ...
      <section class="about-tag">
         <div class="container">
            <div class="row">
               <h3 class="text-anime-style-2" data--delay="0.3s">
      ...
      <div class="page-about">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-lg-6" data--delay="0.3s">
               ...
               <div class="col-lg-6" data--delay="0.4s">
                  <div class="about-us-content">

                     <p class="" data--delay="0.5s">
                     ...
                     <p class="" data--delay="0.6s">
                        <b>Runo was born out of this vision.</b>
                     </p>
                     <p class="" data--delay="0.7s">
                     ...
                     <p class="" data--delay="0.8s"><b>So, what sets us apart?</b></p>
                     <p class="" data--delay="0.9s">
      ...
      <div class="page-about">
         <div class="container">
            <div class="row align-items-center">
               <div class="col-lg-6" data--delay="0.3s">
                  <div class="about-us-content">
                     <p class="" data--delay="0.4s" style="text-align:left;">
      ...
      <section class="home-app-cta  animate__animated animate__fadeInUp" data--delay="0.2s">
         <div class="container">
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#requestDemoModal" data-label="Start 10-day free trial - About CTA 2" class="btn-schedule track-btn  animate__animated animate__zoomIn" data--delay="0.6s">
               Schedule Your Demo
            </a>
