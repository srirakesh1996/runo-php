            ...
            <div class="container legal-content">
                <div class="row">
                    <div class="col-lg-12  fadeInUp" data--delay="0.2s">
                        ...
                        <h4>PRODUCT AND USAGE</h4>

                        <p>The mobile application or the website platform or software can be used in following manner.</p>

                        <p>The Product RUNO is available only in the application format and can be accessed through Google “play store” and Apple “App store”. The application requires login and the data is stored on the device of the user as well as our cloud storage hosted on AWS. The application also allows user to save notes and status in the application, with the data being stored in the customer device. The user can use the short messaging service or message through apps like WhatsApp or email for sending any communication with the customer. The application uses device storage to read media information such as Call Recordings and Call Logs and this information is sent to our Cloud servers.</p>

                        <p>The applicant creates a login to start using our service. The service is free for 10 (Ten) days and chargeable thereafter based on the tariff shown at the time of payment.</p>

                        <p>This privacy policy applies to all information collected through our website or mobile application (such as www.runo.in, Android or IOS Application) ("Apps"), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "Sites").</p>
                        ...
                        <p><strong>In Short:</strong> We collect personal information that you provide to us such as name, address, contact information, passwords and security data and payment information (if applicable) data.</p>
                        <p>
                        ...
                        <p><strong>As per details on www.runo.in or the application installed</strong></p>
                        ...
                        <p><strong>In Short:</strong> We may collect information regarding your geo-location, mobile device, and push notifications when you use our apps.</p>
                        <p>
                            If you use our Apps, we may also collect the following information:
                        </p>
                        <ul>
                            <li><strong>Geo-Location Information:</strong> We may request access or permission to and track location-based information from your mobile device...</li>
                            <li><strong>Mobile Device Access:</strong> We may request access or permission to certain features from your mobile device...</li>
                            <li><strong>Mobile Device Data:</strong> We may automatically collect device information...</li>
                            <li><strong>Push Notifications:</strong> We may request to send you push notifications...</li>
                        </ul>
                        ...
                        <p><strong>In Short:</strong> We process your information for purposes based on legitimate business interests, the fulfilment of our contract with you, compliance with our legal obligations, and/or your consent.</p>
                        ...
                        <ul>
                            ...
                            <li><strong>To post testimonials:</strong> We post testimonials on our Sites that may contain personal information. Prior to posting a testimonial, we will obtain your consent to use your name and testimonial. If you wish to update, or delete your testimonial, please contact us at <a href="mailto:care@runo.in">care@runo.in</a> and be sure to include your name, testimonial location, and contact information.</li>

                            <li><strong>To display logos:</strong> We may display logos of our clients on our website to showcase our portfolio and demonstrate our past work. However, we respect the privacy of our clients and will not disclose any confidential information without prior permission.</li>

                            <li><strong>Deliver targeted advertising to you:</strong> We may use your information to develop and display content and advertising (and work with third parties who do so) tailored to your interests and/or location and to measure its effectiveness. For more information, see our Cookie Policy.</li>
                        ...
                        <p><strong>In Short:</strong> We only share information with your consent, to comply with laws, to protect your rights, or to fulfil business obligations. We only share and disclose your information in the following situations:</p>
                        ...
                        <ul>
                            ...
                            <li><strong>Affiliates:</strong> We may share your information with our affiliates, in which case we will require those affiliates to honour this privacy policy. Affiliates include our parent company and any subsidiaries, joint venture partners or other companies that we control or that are under common control with us.</li>
                        ...
                        <p>This website or mobile application uses Google Maps APIs. You may find the Google Maps APIs Terms of Service here. To better understand Google’s Privacy Policy, please refer to this link.</p>
                        ...
                        <p>For a full list of what we use information for, please see the previous sections. You agree to allow us to obtain or cache your location. You may revoke your consent at anytime. We use information about location in conjunction with data from other data providers.</p>
                        ...
                        <p>In particular Rutakshi Technologies Private Limited complies with the EU-U.S. Privacy Shield Framework as set forth by the U.S. Department of Commerce regarding the collection, use, and retention of personal information transferred from the European Union to the United States and has certified its compliance with it. As such, RUTAKSHI TECHNOLOGIES PVT LTD is committed to subjecting all personal information received from European Union (EU) member countries, in reliance on the Privacy Shield Framework, to the Framework’s applicable Principles. To learn more about the Privacy Shield Framework, visit the U.S. Department of Commerce’s Privacy Shield List.</p>
                        <p>RUTAKSHI TECHNOLOGIES PVT LTD is responsible for the processing of personal information it receives, under the Privacy Shield Framework, and subsequently transfers to a third party acting as an agent on its behalf.</p>
                        <p>With respect to personal information received or transferred pursuant to the Privacy Shield Framework, Rutakshi Technologies Pvt Ltd is subject to the regulatory enforcement powers of the U.S. FTC. In certain situations, we may be required to disclose personal information in response to lawful requests by public authorities, including to meet national security or law enforcement requirements.</p>
                        <p>Runo Call CRM's use and transfer of information received from Google APIs to any other app will adhere to Google API Services User Data Policy, including the Limited Use requirements.</p>
                        ...
                        <p>We will only keep your personal information for as long as it is necessary for the purposes set out in this privacy policy, unless a longer retention period is required or permitted by law (such as tax, accounting or other legal requirements). No purpose in this policy will require us keeping your personal information for longer than 1 year past the termination of your account</p>
                        ...
                        <p>In some regions (like the European Economic Area), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. In certain circumstances, you may also have the right to object to the processing of your personal information. To make such a request, please use the contact details provided in this policy. We will consider and act upon any request in accordance with applicable data protection laws. If we are relying on your consent to process your personal information, you have the right to withdraw your consent at any time.</p>
                        <p>Please note however that this will not affect the lawfulness of the processing before its withdrawal.</p>
                        <p>If you are resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: https://ec.europa.eu/info/law/law-topic/data-protection_en</p>

                        <h4>Account Information</h4>
                        <p>You may at any time review or change the information in your account by:</p>
                        <ul>
                        ...
                        <p><strong>RUTAKSHI TECHNOLOGIES PVT LTD<br>
                                Rajsekhar Patnaik<br>
                                Quadrant 1, Cyber Towers, Hitech City, Madhapur, Hyderabad, Telangana, India - 500081</strong></p>

                        <p>If you are a resident in the European Economic Area, the "data controller" of your personal information is RUTAKSHI TECHNOLOGIES PVT LTD. RUTAKSHI TECHNOLOGIES PVT LTD , has appointed Rajsekhar Patnaik to be its representative in the EEA. You can contact them directly regarding the processing of your information by COMPANY, by email at <a href="mailto:care@runo.in">care@runo.in</a> or by post to:</p>

                        <p><strong>RUTAKSHI TECHNOLOGIES PVT LTD<br>
                                Rajsekhar Patnaik<br>
                                Quadrant 1, Cyber Towers, Hitech City, Madhapur, Hyderabad, Telangana, India - 500081</strong></p>

                        <p>If you have any further questions or comments about us or our policies, email us at <a href="mailto:care@runo.in">care@runo.in</a> or by post to:</p>
